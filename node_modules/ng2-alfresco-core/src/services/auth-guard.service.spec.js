...
describe('AuthGuardService', function () {
    ...
    it('if the alfresco js api is logged in should canActivate be true', testing_2.async(testing_2.inject([auth_guard_service_1.AuthGuard, router_1.Router, alfresco_settings_service_1.AlfrescoSettingsService, storage_service_1.StorageService, alfresco_authentication_service_1.AlfrescoAuthenticationService], function (auth, router, settingsService, storage, authService) {
    ...
    it('if the alfresco js api is NOT logged in should canActivate be false', testing_2.async(testing_2.inject([auth_guard_service_1.AuthGuard, router_1.Router, alfresco_settings_service_1.AlfrescoSettingsService, storage_service_1.StorageService, alfresco_authentication_service_1.AlfrescoAuthenticationService], function (auth, router, settingsService, storage, authService) {
        spyOn(router, 'navigate');
        authService.isLoggedIn = function () {
            return false;
        };
