...
$__System.registerDynamic("2", ["3", "4", "5"], true, function ($__require, exports, module) {
    ...
    }), __param(2, core_1.Inject(platform_browser_1.DOCUMENT)), __metadata("design:paramtypes", [ng2_alfresco_core_1.AlfrescoApiService, core_1.ElementRef, Object, ng2_alfresco_core_1.LogService])], ViewerComponent);
...
$__System.registerDynamic("8", ["3"], true, function ($__require, exports, module) {
    ...
    NotSupportedFormat = __decorate([core_1.Component({
        ...
        template: "<section class=\"section--center mdl-grid mdl-grid--no-spacing\">     <div class=\"viewer-margin mdl-card mdl-cell mdl-cell--9-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone mdl-shadow--2dp\">         <div class=\"viewer-download-text mdl-card__supporting-text viewer-margin\">             <h4>File '<span>{{nameFile}}</span>' is of an unsupported format</h4>         </div>         <div class=\"center-element mdl-card__actions\">             <button id=\"viewer-download-button\" class=\"mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent\" (click)=\"download()\">                 <i class=\"viewer-margin-cloud-download material-icons\">cloud_download</i>   Download             </button>         </div>     </div> </section>",
        styles: [" .viewer-download-text  {     text-align: center;     word-wrap: break-word; }  .viewer-margin-cloud-download{     margin-right: 20px; }  .viewer-margin {     margin: auto !important; }  .center-element {     display: flex;     align-items: center;     justify-content: center; }  .full_width{     width :95% !important; }"]
    })], NotSupportedFormat);
...
$__System.registerDynamic("9", ["3"], true, function ($__require, exports, module) {
    ...
    RenderingQueueServices = __decorate([core_1.Injectable()], RenderingQueueServices);
    exports.RenderingQueueServices = RenderingQueueServices;
});
$__System.registerDynamic("a", ["3", "5", "9"], true, function ($__require, exports, module) {
    /*!
     * @license
     * Copyright 2016 Alfresco Software, Ltd.
     *
    ...
    }), __metadata("design:paramtypes", [rendering_queue_services_1.RenderingQueueServices, ng2_alfresco_core_1.LogService])], PdfViewerComponent);
