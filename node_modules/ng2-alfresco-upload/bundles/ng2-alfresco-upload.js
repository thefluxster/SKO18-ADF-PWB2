...
(["1"], ["3","4","8"], true, function($__System) {
...
$__System.registerDynamic("2", ["3", "4", "5"], true, function ($__require, exports, module) {
    ...
    var upload_service_1 = $__require("5");
    ...
    var UploadDragAreaComponent = UploadDragAreaComponent_1 = function () {
        ...
        UploadDragAreaComponent.prototype.onFolderEntityDropped = function (folder) {
            ...
            if (folder.isDirectory) {
                ...
                this.uploadService.createFolder(relativePath, folder.name).subscribe(function (message) {
    ...
    __decorate([core_1.Input(), __metadata("design:type", Boolean)], UploadDragAreaComponent.prototype, "showNotificationBar", void 0);
    ...
    }), __metadata("design:paramtypes", [upload_service_1.UploadService, ng2_alfresco_core_1.AlfrescoTranslationService, ng2_alfresco_core_1.LogService, ng2_alfresco_core_1.NotificationService])], UploadDragAreaComponent);
...
$__System.registerDynamic("7", ["3", "8", "4", "5"], true, function ($__require, exports, module) {
    /*!
     * @license
     * Copyright 2016 Alfresco Software, Ltd.
     *
    ...
    var UploadButtonComponent = UploadButtonComponent_1 = function () {
        ...
        UploadButtonComponent.prototype.onDirectoryAdded = function ($event) {
            ...
            hashMapDir.forEach(function (filesDir, directoryPath) {
                ...
                _this.uploadService.createFolder(absolutePath, directoryName).subscribe(function (res) {
    ...
    __decorate([core_1.Input(), __metadata("design:type", Boolean)], UploadButtonComponent.prototype, "showNotificationBar", void 0);
    ...
    __decorate([core_1.Input(), __metadata("design:type", String)], UploadButtonComponent.prototype, "staticTitle", void 0);
    ...
    }), __metadata("design:paramtypes", [core_1.ElementRef, upload_service_1.UploadService, ng2_alfresco_core_1.AlfrescoTranslationService, ng2_alfresco_core_1.LogService, ng2_alfresco_core_1.NotificationService])], UploadButtonComponent);
...
$__System.registerDynamic("5", ["3", "8", "4", "b"], true, function ($__require, exports, module) {
    /*!
     * @license
     * Copyright 2016 Alfresco Software, Ltd.
     *
    ...
    var UploadService = function () {
        function UploadService(apiService, logService) {
            ...
            this.versioning = false;
            this.totalCompleted = 0;
            this.filesUpload$ = new Rx_1.Observable(function (observer) {
                return _this.filesUploadObserverProgressBar = observer;
            }).share();
            this.totalCompleted$ = new Rx_1.Observable(function (observer) {
        ...
        UploadService.prototype.createFolder = function (relativePath, name) {
            var _this = this;
            return Rx_1.Observable.fromPromise(this.callApiCreateFolder(relativePath, name)).map(function (res) {
                return res;
            }).do(function (data) {
                return _this.logService.info('Node data', data);
            }).catch(function (err) {
    ...
    UploadService = __decorate([core_1.Injectable(), __metadata("design:paramtypes", [ng2_alfresco_core_1.AlfrescoApiService, ng2_alfresco_core_1.LogService])], UploadService);
    exports.UploadService = UploadService;
});
$__System.registerDynamic("1", ["3", "4", "2", "6", "7", "9", "a", "5"], true, function ($__require, exports, module) {
    /*!
     * @license
     * Copyright 2016 Alfresco Software, Ltd.
     *
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["@angular/core","ng2-alfresco-core","rxjs/Rx"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("@angular/core"), require("ng2-alfresco-core"), require("rxjs/Rx"));
  else
