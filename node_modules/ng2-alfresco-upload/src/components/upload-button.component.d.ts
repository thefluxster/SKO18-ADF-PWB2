...
export declare class UploadButtonComponent {
    ...
    constructor(el: ElementRef, uploadService: UploadService, translateService: AlfrescoTranslationService, logService: LogService, notificationService: NotificationService);
