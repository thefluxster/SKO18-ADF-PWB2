...
describe('AlfrescoSearchComponent', function () {
    ...
    it('should take the provided search term from query param provided via RouteParams', function () {
        ...
        var search = new alfresco_search_component_1.AlfrescoSearchComponent(null, null, injector.get(router_1.ActivatedRoute));
        search.ngOnInit();
    ...
    it('should have a null search term if no query param provided via RouteParams', function () {
        ...
        var search = new alfresco_search_component_1.AlfrescoSearchComponent(injector.get(alfresco_search_service_1.AlfrescoSearchService), null, injector.get(router_1.ActivatedRoute));
        search.ngOnInit();
    ...
    describe('Search results', function () {
        ...
        it('should display search results when a search term is provided', function (done) {
            ...
            component.resultsLoad.subscribe(function () {
                ...
                var resultsEl = element.querySelector('[data-automation-id="text_MyDoc"]');
    ...
    describe('search result interactions', function () {
        ...
        describe('click results', function () {
            ...
            it('should emit preview event when file item clicked', function (done) {
                component.resultsLoad.subscribe(function () {
                    fixture.detectChanges();
                    var resultsEl = element.querySelector('[data-automation-id="text_MyDoc"]');
            ...
            it('should emit preview event when non-file item is clicked', function (done) {
                querySpy.and.returnValue(Promise.resolve(folderResult));
                component.resultsLoad.subscribe(function () {
                    fixture.detectChanges();
                    var resultsEl = element.querySelector('[data-automation-id="text_MyFolder"]');
                    resultsEl.dispatchEvent(new Event('click'));
                    done();
                });
                component.searchTerm = 'searchTerm';
