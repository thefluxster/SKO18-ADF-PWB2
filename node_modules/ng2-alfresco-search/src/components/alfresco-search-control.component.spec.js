...
describe('AlfrescoSearchControlComponent', function () {
    ...
    it('should update FAYT search when user inputs a valid term', function (done) {
        fixture.componentInstance.searchChange.subscribe(function () {
    ...
    it('should NOT update FAYT term when user inputs a search term less than 3 characters', function (done) {
        fixture.componentInstance.searchChange.subscribe(function () {
    ...
    it('should still fire an event when user inputs a search term less than 3 characters', function (done) {
        fixture.componentInstance.searchChange.subscribe(function (e) {
