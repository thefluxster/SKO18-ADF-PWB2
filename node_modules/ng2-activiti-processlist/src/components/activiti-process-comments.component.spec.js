...
describe('ActivitiProcessInstanceComments', function () {
    ...
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(activiti_process_comments_component_1.ActivitiProcessComments);
        component = fixture.componentInstance;
        service = fixture.debugElement.injector.get(activiti_process_service_1.ActivitiProcessService);
        getCommentsSpy = spyOn(service, 'getProcessInstanceComments').and.returnValue(Rx_1.Observable.of([{
                message: 'Test1'
            }, {
                message: 'Test2'
            }, {
        ...
        addCommentSpy = spyOn(service, 'addProcessInstanceComment').and.returnValue(Rx_1.Observable.of({ id: 123, message: 'Test' }));
    ...
    it('should load comments when processInstanceId specified', function () {
    ...
    it('should not comments when no processInstanceId is specified', function () {
        fixture.detectChanges();
        expect(getCommentsSpy).not.toHaveBeenCalled();
    });
    it('should display comments when the process has comments', testing_1.async(function () {
        var change = new core_1.SimpleChange(null, '123');
        component.ngOnChanges({ 'processInstanceId': change });
    ...
    it('should not display comments when the process has no comments', testing_1.async(function () {
    ...
    describe('change detection', function () {
        ...
        it('should fetch new comments when processInstanceId changed', function () {
            component.ngOnChanges({ 'processInstanceId': change });
        ...
        it('should NOT fetch new comments when processInstanceId changed to null', function () {
...
//# sourceMappingURL=activiti-process-comments.component.spec.js.map