...
describe('Test ng2-alfresco-tag Tag list All ECM', function () {
    var dataTag = {
        'list': {
            'pagination': {
                'count': 3,
    ...
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(tag_list_component_1.TagList);
