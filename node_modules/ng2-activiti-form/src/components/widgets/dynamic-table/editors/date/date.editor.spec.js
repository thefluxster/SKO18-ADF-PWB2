...
var date_editor_1 = require("./date.editor");
var dynamic_table_widget_model_1 = require("./../../dynamic-table.widget.model");
var moment = require("moment");
describe('DateEditorComponent', function () {
    var nativeElement;
    var elementRef;
    var component;
    var row;
    ...
    beforeEach(function () {
        ...
        component = new date_editor_1.DateEditorComponent(elementRef);
        component.table = table;
        component.row = row;
        component.column = column;
    });
    it('should setup date picker on init', function () {
        var trigger = {};
    ...
    it('should require cell value to setup initial date', function () {
        row.value[column.id] = null;
        component.ngOnInit();
        expect(component.settings.init).toBeUndefined();
    });
    it('should require dom element to setup trigger', function () {
        component = new date_editor_1.DateEditorComponent(null);
        component.table = table;
        component.row = row;
        component.column = column;
        component.ngOnInit();
    ...
    it('should update fow value on change', function () {
        component.ngOnInit();
    ...
    it('should require dom element to update material textfield on change', function () {
        component = new date_editor_1.DateEditorComponent(null);
        component.table = table;
        component.row = row;
        component.column = column;
    ...
    it('should require dom element to update material textfield', function () {
        var result = component.updateMaterialTextField(null, 'value');
        expect(result).toBeFalsy();
    });
    it('should require native dom element to update material textfield', function () {
        elementRef.nativeElement = null;
        var result = component.updateMaterialTextField(elementRef, 'value');
        expect(result).toBeFalsy();
    });
    it('should require input element to update material textfield', function () {
        spyOn(nativeElement, 'querySelector').and.returnValue(null);
        var result = component.updateMaterialTextField(elementRef, 'value');
        expect(result).toBeFalsy();
    });
    it('should update material textfield with new value', function () {
        var called = false;
        var value = '<value>';
    ...
    it('should update picker when input changed', function () {
        var input = '14-03-2016';
        var event = { target: { value: input } };
        component.ngOnInit();
        component.onDateChanged(event);
        expect(component.datePicker.time.isSame(moment(input, 'DD-MM-YYYY'))).toBeTruthy();
    });
    it('should update row value upon user input', function () {
        var input = '14-03-2016';
        var event = { target: { value: input } };
        component.ngOnInit();
        component.onDateChanged(event);
        var actual = row.value[column.id];
        expect(actual).toBe('2016-03-14T00:00:00.000Z');
    });
    it('should flush value on user input', function () {
...
//# sourceMappingURL=date.editor.spec.js.map