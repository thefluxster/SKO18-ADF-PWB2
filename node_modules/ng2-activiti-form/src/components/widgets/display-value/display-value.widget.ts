...
export class DisplayValueWidget extends WidgetComponent implements OnInit {
	...
	editInWordUrl(){
		return this.sanitizer.bypassSecurityTrustUrl('ms-word:ofe|u|http://demo:9090/activiti-app/aos/' + this.id + '/' + this.value);
	}
	
	iframeUrl(){
		return this.sanitizer.bypassSecurityTrustResourceUrl('http://demo:9090/activiti-app/workflow/views/templates/viewer.html?file=/activiti-app/app/rest/content/' + this.id + '/rendition/preview');
	}
}
