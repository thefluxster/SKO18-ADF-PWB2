...
export const appRoutes: Routes = [
  ...
  {
    path: 'mincorro/apps/:appId/tasks',
    component: MincorroDemoComponent,
    canActivate: [AuthGuardBpm]
  },
  {
    path: 'mincorro/appId/:appId',
    component: MincorroDemoComponent,
    canActivate: [AuthGuardBpm]
  },
  {
  ...
  {
    path: 'mincorro/tasks/:id',
    component: MincorroFormViewer,
    canActivate: [AuthGuardBpm]
  },
  {
